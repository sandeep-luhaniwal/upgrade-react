...
import { FOOTER_POLICY_LINKS, NAVIGATION_LINK_LIST, SOCIAL_MEDIA_LINK_LIST } from '../../utlis/helper';
...
const Footer = () => {
    ...
    return (
        <div className='bg-black-light/10'>
            <div className='max-w-[1140px] mx-auto px-4 xl:px-0 py-5 flex flex-col justify-center items-center'>
                <Link to="/">
                ...
                <p className='text-black py-4 font-semibold text-sm leading-100'>Send Your Feedback : <Link className='font-normal text-black duration-300 hover:text-green' to={'mailto:moc.edargpu@tcatnoc'}>moc.edargpu@tcatnoc</Link></p>
                ...
                <p className='text-due-green pt-5 pb-2 text-base leading-150'>© {year} Design Monks. All rights reserved.</p>
            </div>
        </div>
    );
};
